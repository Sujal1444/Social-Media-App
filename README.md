...
- **SignUp/Register Page**: User registration with form validation
- **Login Page**: Secure user authentication
- **Home Page**: Timeline with posts from followed users
- **Post Sharing**: Create and share new posts with images and captions
- **User Profile Page**: View and edit user profile information
- **Interactive Features**: Like/unlike posts, follow/unfollow users
